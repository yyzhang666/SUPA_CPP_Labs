...
FiniteFunction::~FiniteFunction(){
  //if(m_plotfunction){std::cout<<"function true "<<std::endl;} else {std::cout<<"function false "<<std::endl;}
  //if(m_plotdatapoints){std::cout<<"data true "<<std::endl;} else{std::cout<<"data false "<<std::endl;}
...
void FiniteFunction::plotFunction(){
  ...
  m_plotfunction = true;
  //if(m_plotfunction){std::cout<<"function true";}
}
...
void FiniteFunction::plotData(std::vector<double> &points, int Nbins, bool isdata){
  ...
  //if(m_plotdatapoints){std::cout<<"data true";}
}
